...
const Unauthorized = () => {
    ...
    return (
        <section className="flex items-center h-full sm:p-16 bg-coolGray-50 text-coolGray-800">
            <div
                ...
                <p className="text-3xl">403 - Unauthorized</p>

                <span className="px-8 py-3 font-semibold rounded bg-violet-600 text-coolGray-50 cursor-pointer"
