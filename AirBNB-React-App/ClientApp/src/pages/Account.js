...
export const Account = () => {
    ...
    return (
        <>
            <div className="flex flex-col h-full p-3 w-60 bg-coolGray-50 text-coolGray-800">
                <div className="space-y-3">
                    <div className="flex items-center justify-between">
                        <h2>Dashboard</h2>
                        <button className="p-2">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"
                                 className="w-5 h-5 fill-current text-coolGray-800">
                    ...
                    <div className="relative">
                        ...
                        <input type="search" name="Search" placeholder="Search..."
                               className="w-full py-2 pl-10 text-sm border-transparent rounded-md focus:outline-none bg-coolGray-100 text-coolGray-800 focus:bg-coolGray-50"/>
                    </div>
                    <div className="flex-1">
                        <ul className="pt-2 pb-4 space-y-1 text-sm">
                            ...
                            <li className="rounded-sm bg-coolGray-100 text-coolGray-900">
                                <a href="" className="flex items-center p-2 space-x-3 rounded-md">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"
                                         className="w-5 h-5 fill-current text-coolGray-600">
                                        <path
