        ...
        <div className="bg-gray-900">
            <div className="px-4 py-5 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
                <div className="relative flex items-center justify-between">
                    ...
                    >
                        <svg
                            className="w-8 text-teal-accent-400 cursor-pointer"
                            viewBox="0 0 24 24"
                        ...
                        <span className="ml-2 text-xl font-bold tracking-wide text-gray-100 uppercase cursor-pointer">
                          Inside Airbnb
                        </span>
                    </span>
                                ...
                                <div className="p-5 bg-white border rounded shadow-sm">
                                    <div className="flex items-center justify-between mb-4">
                                        <div>
                                            ...
                                            >
                                                <svg
                                                    className="w-8 text-deep-purple-accent-400 cursor-pointer"
                                                    viewBox="0 0 24 24"
                                                    strokeLinejoin="round"
                                                    strokeWidth="2"
                                                    strokeLinecap="round"
                                                ...
                                                <span
                                                    className="ml-2 text-xl font-bold tracking-wide text-gray-800 uppercase cursor-pointer">
                                                  Inside Airbnb
                                                </span>
                                            </a>
                                        </div>
